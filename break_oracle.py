...
"""This is a black-box attack on an oracle that exploits the statelessness of AES-128-ECB and the block size (16) to decrypt a secret message 
Example: This sort of attack could be used on vulnerable webservers to extract information on user data, and even achieve authentication as admin"""
